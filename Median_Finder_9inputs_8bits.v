module Median_Finder_9inputs_8bits(
    ...
    assign en_stage0 = start | pipe_valid[0];
    assign en_stage1 = pipe_valid[1] | pipe_valid[2];
    assign en_stage2 = pipe_valid[3] | pipe_valid[4];
    ...
    Ascending_Sorter_3inputs_8bits Row0(
        ...
        .clk(clk), .reset(reset), .enable(en_stage0)
    );
    ...
    Ascending_Sorter_3inputs_8bits FindMax(
        ...
        .clk(clk), .reset(reset), .enable(en_stage1)
    );
    ...
    Ascending_Sorter_3inputs_8bits FindMedian(
        ...
        .clk(clk), .reset(reset), .enable(en_stage2)
    );
